...
describe('greeting', function() {
	...
	it('sets the output element\'s text to "Hello, BMAX!" when the "Run" button is clicked.', function() {

		// load the HTML needed for this test
		jasmine.getFixtures().load('examples.html');

		var
		$runButton = $('[data-action="greeting"]'),
		$output = $('#greeting [data-output]'),
		 ...
		 */
		expect($output.text()).toEqual('Hello, BMAX!');
