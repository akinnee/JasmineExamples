...
CopyApi.prototype.getJsonRpcClient = function() {
...
CopyApi.prototype.listJsExamplesDirContents = function(successCallback, errorCallback, breakOnPurpose) {
	var client = this.getJsonRpcClient();
...
CopyApi.prototype.getNameFromPath = function(path) {
	var
...
$(function() {
	...
	$('body').on('click', '[data-action="apiCallExample"]', function() {
		...
		var
		$outputElement = $('#apiCallExample [data-output]'),
		copyApi = new CopyApi();
